...
namespace Cyrillic.Convert.Product.ConcreteProducts
{
    ...
    {
        private readonly Dictionary<char, string> toLatin;              // Armenian -> Latin
        private readonly Dictionary<char, string> startLatin;           // unused
        private readonly Dictionary<string, string> special;            // none for simplified
        private readonly Dictionary<string, string> toCyrillic;         // Latin -> Armenian
        private readonly Dictionary<string, string> startToCyrillic;    // unused
        ...
        public Armenian()
        {
            ...
            void A(char c, string l) => toLatin[c] = l;

            // Uppercase
            A('\u0531', "A"); A('\u0532', "B"); A('\u0533', "G"); A('\u0534', "D"); A('\u0535', "Ye");
            A('\u0536', "Z"); A('\u0537', "E"); A('\u0538', "Eh"); A('\u0539', "Th"); A('\u053A', "Zh");
            A('\u053B', "I"); A('\u053C', "L"); A('\u053D', "X"); A('\u053E', "Ts"); A('\u053F', "K");
            A('\u0540', "H"); A('\u0541', "Dz"); A('\u0542', "Gh"); A('\u0543', "Tch"); A('\u0544', "M");
            A('\u0545', "Y"); A('\u0546', "N"); A('\u0547', "Sh"); A('\u0548', "Vo"); A('\u0549', "Ch");
            A('\u054A', "P"); A('\u054B', "J"); A('\u054C', "R"); A('\u054D', "S"); A('\u054E', "V");
            A('\u054F', "T"); A('\u0550', "Rr"); A('\u0551', "C"); A('\u0552', "Yw"); A('\u0553', "Ph");
            A('\u0554', "Kh"); A('\u0555', "O"); A('\u0556', "F");
